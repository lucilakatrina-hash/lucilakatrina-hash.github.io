...
VERDE = (0, 200, 0)
ROJO = (200, 0, 0)
ROSA = (255, 82, 121) #CAMBIO: COLOR AZUL POR ROSA
...
# Carga de imágenes de dados (ajusta la ruta si es necesario) (CAMBIO:DADOS DE CORAZONES)
...
#COMPLETAR ESTA FUNCIÓN, DEBE DEVOLVER LA TIRADA DE UN DADO. LUEGO BORRAR LA PALABRA PASS (TERMINADO)
def tirar_dado():
...
def evaluar_ronda():
    ...
    if jugador_suma>10 and cpu_suma>10:
        resultado=("Ambos de pasaron, nadie gana")
    elif jugador_suma==cpu_suma:
        resultado= ("¡Empate!") 
    elif jugador_suma>10:
        resultado=("¡Te pasaste, CPU gana!")
    elif cpu_suma>10:
        resultado=("CPU se pasó, has ganado!")
    elif jugador_suma>cpu_suma:
        resultado=("¡Ganaste!")
    else:
        resultado= ("¡CPU gana, has perdido!") 
    #Acá determinar si hubo empate, si alguien ganó quién fue, y si alguien se pasó quién fue.
    #Guardar esta informaciópn en la variable resultado en forma de texto. (TERMINADO)
